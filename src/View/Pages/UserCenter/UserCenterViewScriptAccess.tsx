...
export class UserCenterViewScriptAccess extends React.Component<Props | any, State> {
    ...
    async componentDidMount() {
        ...
        const route = this.props.isAdmin ? 'adminUser/scriptAccess' : 'script/listAccess';
        const access = await this.api.post(route, {
            ...
            <div>
                ...
                <div className="table-responsive">
                    <table className="table table-bordered table-striped">
                        <thead>
                        <tr>
                            {!this.props.isAdmin && <th scope="col">Renew</th>}
                        ...
                        {this.state.access.map((o => {
                            return (<tr>
                                {!this.props.isAdmin && o.script.type === ScriptType.Premium && <td><a href={"javascript:void(0)"} onClick={(e) => this.repurchase(e, o)}>Renew</a></td>}
                                {!this.props.isAdmin && o.script.type !== ScriptType.Premium && <td/>}
                                <td>{o.script.name}</td>
